...
const sectionPallet = document.getElementById('section-color-palette');
const btnRandom = document.createElement('button');
btnRandom.id = 'button-random-color';
btnRandom.innerText = 'Cores aleatórias';
sectionPallet.appendChild(btnRandom);
...
inputVqv.addEventListener('input', function (event) {
  ...
  console.log('number2', number2, 'number1', number);
});
...
function btnVqv() {
  ...
  btn.addEventListener('click', function () {
    ...
    if (number2 < number) {
      ...
      alert('Board inválido! 50 é o máximo permitido');
